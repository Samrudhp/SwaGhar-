...
const Navigation = ({ themeMode, toggleTheme }) => {
  ...
  return (
    ...
    //tst two
    <nav
      className={`relative top-5 mx-auto w-11/12 lg:w-10/12 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 shadow-lg rounded-xl transform transition-all duration-300 ${isMenuOpen ? 'z-50' : ''
        }`}
